    ...
    const getAll = async () => {
        /* This method returns a Promise that when resolved, gives us an array with 2 fields: [rows, fields] . The first index is where the answer we want is (in this case Authors) and in the second there is some extra information about the query that we will not use. */
