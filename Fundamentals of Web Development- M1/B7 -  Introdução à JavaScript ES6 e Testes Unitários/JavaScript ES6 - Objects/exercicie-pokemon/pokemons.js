...
function selectPokemon() {
  ...
  const fase2 = (pokemon, lvl) => {
    if (pokemon == 'bulbasaur' && lvl >= 16) {
  ...
  const fase3 = (pokemon, lvl) => {
    if (pokemon == 'bulbasaur' && lvl >= 36) {
...
function printPokemon() {
  ...
  return bulbasaurEvolutions(), pokemonDefaut(),squartleEvolutions(),charmanderEvolutions();
}
